...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/arpi/automotive_rpi4/bluetooth
BOARD_CUSTOM_BT_CONFIG := device/arpi/automotive_rpi4/bluetooth/vnd_rpi4.txt

BOARD_SEPOLICY_DIRS := \
    device/arpi/automotive_rpi4/sepolicy

DEVICE_MANIFEST_FILE := device/arpi/automotive_rpi4/manifest.xml
